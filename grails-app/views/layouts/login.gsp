...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <link rel="stylesheet" href="${createLinkTo(dir:'plugins/party-time-0.3/css',file:'960.css')}" />
        <link rel="stylesheet" href="${createLinkTo(dir:'plugins/party-time-0.3/css',file:'960.reset.css')}" />
        <link rel="stylesheet" href="${createLinkTo(dir:'plugins/party-time-0.3/css',file:'960.text.css')}" />
        <link rel="stylesheet" href="${createLinkTo(dir:'plugins/party-time-0.3/css',file:'site.css')}"  />
        <link rel="stylesheet" href="${createLinkTo(dir:'plugins/party-time-0.3/css',file:'style.css')}" />
