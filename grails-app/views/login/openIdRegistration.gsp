    ...
    <body>
        ...
        <div id="content-body" class="container_12">
            ...
            <openid:ifNotLoggedIn>
                ...
                <openid:form success="[controller:'login', action:'openIdRegistration']" error="[controller:'login', action:'openIdError']">
            ...
            <openid:ifLoggedIn>
                        <g:form action="registersaveWithOpenId" method="post" >
                            <div class="dialog">
                                <table>
                                    <tbody>
